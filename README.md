...
Blockchain technology emerges as a groundbreaking solution poised to address the inherent deficiencies of current land title systems. At its core, blockchain offers a decentralized, secure, and immutable framework that holds the promise of revolutionizing land records management. By fundamentally altering the way information is verified and stored, blockchain enables the creation of a reliable and transparent land record and management system. Through its innovative approach, blockchain ensures data integrity by requiring consensus across multiple nodes, thereby mitigating the risk of manipulation and fraud.

The adoption of blockchain technology not only addresses the shortcomings of existing land title systems but also facilitates the digitization of records, ushering in a new era of efficiency and transparency in land administration. Digitization plays a pivotal role in accelerating various aspects of land management, including interaction facilitation, security enhancement, operational flexibility, and information discoverability. By digitizing records and related information, stakeholders can streamline processes, enhance data security, and improve access to critical information, thereby bolstering overall efficiency and effectiveness in land administration.
...
In summary, the problem at hand revolves around the shortcomings of the current framework, including its susceptibility to cyber threats, erosion of user trust, and inefficiency in handling large-scale digitalization efforts. Addressing these challenges is imperative to instill confidence in digital record-keeping processes and propel the transition towards more secure and efficient data management solutions.
...
A comprehensive overview of blockchain technology is provided, explaining its decentralized and distributed nature, as well as its key features such as immutability and consensus mechanisms. The authors discuss how blockchain can address the security concerns and inefficiencies of the current land record system by providing a secure and transparent platform for storing and accessing land records.
The paper reviews existing literature on blockchain-based land registration systems, citing various studies and projects that have explored the potential of blockchain technology in this domain. Examples include implementations using Proof of Work algorithms, Ethereum Virtual Machine, and delegated proof of stake consensus mechanisms. The authors analyze the strengths and limitations of these approaches, providing insights into the state of the art in blockchain-based land record systems.
The proposed methodology for implementing a blockchain-based land record system is presented in detail. The authors describe the development of smart contracts using the Ethereum blockchain, which allow for the secure storage and retrieval of land records. They explain the roles of different users, including citizens and government officials, and outline the steps involved in adding, updating, and accessing land records through a web portal
The paper provides an overview of the proposed model, highlighting its key objectives such as eliminating intermediaries, enhancing security, and providing 24/7 accessibility to land records. The authors emphasize the benefits of blockchain technology, including data immutability, transparency, and efficiency in land transactions. They discuss how the proposed model addresses the limitations of the current system and offers significant improvements in terms of security and reliability.
...
Blockchain technology, with its immutable ledger and decentralized nature, offers promising solutions to issues prevalent in traditional land registry systems. By leveraging distributed ledger technology (DLT) and consensus mechanisms, the proposed system aims to provide a transparent, secure, and tamper-proof platform for property transactions.




The paper discusses related work in the field, showcasing various consensus mechanisms such as Proof-of-Work (PoW), Proof-of-Stake (PoS), and Byzantine Fault Tolerance (BFT). It also highlights previous research efforts in blockchain-based solutions for land registration and real estate transactions, emphasizing the potential of blockchain to mitigate fraud, errors, and administrative burdens in land management processes.
Furthermore, the paper presents a detailed analysis of the proposed consensus algorithms, including Round Robin Consensus Algorithm and Modified Round Robin Consensus Algorithm. It outlines the workflow of each module within these algorithms, covering leader node selection, block creation, validation, and block addition to the blockchain.
...
Digital Land Registry System using Blockchain
	...
	Increased Transparency, reduced fraud, elimination of intermediaries’ faster transaction processing, improved accuracy in land ownership records
	Potential challenges with scalability, integration with existing systems, ensuring user adoption of blockchain technology.
The efficient consensus algorithm for land record management system
	Implementing a Modified Round Robin Consensus Algorithm	Enhanced Security, transparency, immutability, and accessibility of land records.	The need for further validation and testing in real-world scenarios to assess scalability and robustness.

Land Registration System Using Blockchain
	Utilizing Hyperledger Fabric to create a permissioned blockchain System with smart Contracts.
	Increased transparency, efficiency and security in land registration, decentralized system reducing reliance on central authority.
	Complexity of implementation, potential challenges in transitioning from traditional systems, scalability issues.
Survey on Blockchain and online Land Registration
	Technique employed here was quantitative survey methodology. This involves collecting data through structured questionnaires or surveys to gather numerical data that can be analyzed statistically.
	Provides insights into user preferences and attitudes towards blockchain-based land registration systems. 
Identifies inefficiencies of traditional land registration methods	Limited scope to gauge real-world implementation challenges
Relies on self-reported data which may be biased or inaccurate. May not capture nuances of user attitudes towards blockchain technology due to simplified survey questions
Land Registration: Use-case of e-Governance using Blockchain Technology
	The technique employed in this research involves the implementation and evaluation of a blockchain framework for land registration using Hyperledger Fabric
Hyperledger Fabric provides the necessary tools and infrastructure for building enterprise-grade blockchain applications, offering features such as permissioned access, scalability, and confidentiality.
	Enhanced transparency and accountability in e-Governance systems.
Elimination of corruption and manipulation in land registration.
Increased trust between citizens and government institutions.

	Complexity of implementing blockchain technology in existing systems.
Potential resistance to change from entrenched bureaucratic structures.

Secure Land Registration Using Blockchain
	The technique involves the implementation of blockchain technology fortified with cryptographic algorithms like SHA256 and elliptic curve cryptography, along with data structures such as Merkle trees. These cryptographic techniques ensure the security and integrity of land transaction records, while the decentralized nature of blockchain enhances transparency and reduces the potential for fraudulent activities.
	Enhanced security and transparency in land transactions.
Automation of the land registry process, reducing manual effort.
Reduction in fraudulent activities and unauthorized access.
	Complexity of implementing and managing blockchain systems.
...
Building trust among both the government and the people is essential for the successful adoption of digitalization in land registration. By implementing robust encryption algorithms and electronic signatures, the system ensures the security and integrity of data, fostering trust in the digitalization process. Moreover, the transparent and decentralized nature of the peer-to-peer network instills confidence in users by providing them with greater control and visibility over their transactions.
...
![image](https://github.com/ranjilion/212220220034-Final-year-project-repository/assets/160312357/808a2ebe-541d-4862-ad0f-37747c5de6d4)
![image](https://github.com/ranjilion/212220220034-Final-year-project-repository/assets/160312357/33dbc41b-dc26-45cf-826a-5d83c6ffa5c8)
...
body {
 width: auto;
  ...
  background-image: linear-gradient( rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url("images/Sellerlogin.jpg");
...
<div class="login-page">
  <div class="form">
    ...
    <form class="login-form" action="sellerloginservlet" method="post">
      <h1 style="color:white">Sign In</h1>
      <br />
      <input type="text" name="mail" placeholder="Username"/>
      <input type="password" name="pass"  placeholder="Password"/>
      <button type="submit">login</button>
      <p class="message">Not registered? <a href="SellerRegisteration.jsp" style="color:#fc7e0f";>Create an account</a></p>
    </form>
  </div>
</div>
</body>
...
<div class="login-page">
  <div class="form">
    ...
    <form class="login-form" action="buyerloginservlet" method="post">
      <h1 style="color:white">Sign In</h1>
      <br />
      
      <input type="text" name="buyername" placeholder="Username"/>
      <input type="password" name="buyerpass" placeholder="Password"/>
      <button type="submit">login</button>
      <p class="message">Not registered? <a href="BuyerRegister.jsp" style="color:#fc7e0f";>Create an account</a></p>
    </form>
  </div>
</div>
</body>
...
Moreover, blockchain technology offers enhanced security measures to protect land records from unauthorized access and tampering. The use of cryptographic techniques, such as the SHA-256 hash algorithm, ensures that data stored on the blockchain is securely encrypted and virtually impossible to alter without detection. Each block in the blockchain contains a unique cryptographic hash of the previous block, creating a chain of interconnected blocks that are resistant to tampering. Additionally, the decentralized nature of blockchain networks means that even if one node is compromised, the integrity of the entire system remains intact. This robust security infrastructure makes blockchain an ideal solution for safeguarding sensitive land records against cyber threats and data breaches.

In addition to security and transparency, blockchain technology offers unparalleled resilience and availability, ensuring the long-term accessibility of land records. Traditional land record systems often face challenges such as data loss, system failures, and natural disasters, which can lead to the loss or destruction of critical information. By distributing copies of the blockchain ledger across multiple nodes in a network, blockchain technology mitigates the risk of data loss and ensures continuous availability. Even in the event of a node failure or network outage, the decentralized nature of blockchain ensures that other nodes can still access and verify the integrity of the data. This resilience makes blockchain an ideal solution for storing and managing land records, particularly in regions prone to political instability or environmental hazards.

Furthermore, the adoption of blockchain technology for land record management can streamline administrative processes and reduce operational costs. Traditional land record systems often involve manual paperwork, cumbersome administrative procedures, and intermediaries, leading to inefficiencies and delays. By digitizing land records on a blockchain platform, governments and organizations can automate routine tasks such as property transfers, title registrations, and land surveys. Smart contracts, self-executing agreements encoded on the blockchain, can facilitate the automatic transfer of ownership rights based on predefined conditions, eliminating the need for intermediaries and reducing the risk of human error. This automation not only accelerates the pace of transactions but also reduces administrative overheads, ultimately enhancing the efficiency and cost-effectiveness of land record management.

In conclusion, blockchain technology holds immense potential for securing land records in a robust and transparent manner. By leveraging cryptographic techniques and decentralized consensus protocols, blockchain ensures the integrity, security, and availability of land records, thereby reducing the risk of fraud, corruption, and data breaches. Moreover, blockchain technology offers opportunities for streamlining administrative processes, improving operational efficiency, and reducing costs. As governments and organizations continue to explore innovative solutions for land record management, blockchain stands out as a promising technology that can revolutionize the way land records are stored, accessed, and managed in the digital age.
